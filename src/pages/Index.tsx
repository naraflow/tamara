    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 left-10 w-64 h-64 bg-gradient-to-br from-yellow-200/10 to-yellow-400/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-20 right-10 w-80 h-80 bg-gradient-to-tr from-tamara-200/10 to-tamara-400/10 rounded-full blur-3xl"></div>
          <div className="absolute top-1/2 left-1/3 w-72 h-72 bg-gradient-to-bl from-yellow-300/10 to-tamara-300/10 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-32 right-20 animate-[float_6s_ease-in-out_infinite]">
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-15">
          ...
          <div className="absolute bottom-40 left-16 animate-[float_8s_ease-in-out_infinite_2s]">
            <svg width="52" height="52" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-15">
          ...
          <div className="absolute top-48 left-24 animate-[float_7s_ease-in-out_infinite_1s]">
            <svg width="44" height="44" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-15">
          ...
          <div className="absolute top-24 left-1/4 animate-[float_5s_ease-in-out_infinite_3s]">
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-10">
          ...
          <div className="absolute bottom-32 right-1/4 animate-[float_6s_ease-in-out_infinite_4s]">
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-10">
